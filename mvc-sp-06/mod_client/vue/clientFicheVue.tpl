                            ...
                            <div class="card-body card-block">
                              {if $action neq 'ajouter'}
                                <div class="form-group">
                                    ...
                                    <input type="text" name="codec" class="form-control" readonly value="{$unClient->getCodec()}">
                                </div>
                              {/if}
                                <div class="form-group">
                                    <label class="form-control-label" for="nom">Nom et Prénom :</label>
                                    <input type="text" name="nom" class="form-control" {$readonly} value="{$unClient->getNom()}">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="adresse">Adresse :</label>
                                    <input type="text" name="adresse" class="form-control" {$readonly} value="{$unClient->getAdresse()}">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="cp">Code Postal :</label>
                                    <input type="text" name="cp" class="form-control" {$readonly} value="{$unClient->getCp()}">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="ville">Ville :</label>
                                    <input type="text" name="ville" class="form-control" {$readonly} value="{$unClient->getVille()}">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="telephone">Téléphone :</label>
                                    <input type="text" name="telephone" class="form-control" {$readonly} value="{$unClient->getTelephone()}">
                                </div>
                            </div>
