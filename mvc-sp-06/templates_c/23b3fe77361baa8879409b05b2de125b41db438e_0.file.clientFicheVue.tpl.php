<?php
/* Smarty version 4.3.2, created on 2024-01-29 14:04:50
  from 'C:\laragon\www\seraphinparys\mvc-sp-04\mod_client\vue\clientFicheVue.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.2',
  'unifunc' => 'content_65b7b0820665f3_19244952',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '23b3fe77361baa8879409b05b2de125b41db438e' => 
    array (
      0 => 'C:\\laragon\\www\\seraphinparys\\mvc-sp-04\\mod_client\\vue\\clientFicheVue.tpl',
      1 => 1706537084,
      2 => 'file',
    ),
  ),
...
function content_65b7b0820665f3_19244952 (Smarty_Internal_Template $_smarty_tpl) {
?><!doctype html>
<!--[if lt IE 7]>
...
">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nom" class="form-control" readonly value="<?php echo $_smarty_tpl->tpl_vars['unClient']->value->getNom();?>
">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="adresse">Adresse :</label>
                                    <input type="text" name="adresse" class="form-control" readonly value="<?php echo $_smarty_tpl->tpl_vars['unClient']->value->getAdresse();?>
">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="cp">Code Postal :</label>
                                    <input type="text" name="cp" class="form-control" readonly value="<?php echo $_smarty_tpl->tpl_vars['unClient']->value->getCp();?>
">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="ville">Ville :</label>
                                    <input type="text" name="ville" class="form-control" readonly value="<?php echo $_smarty_tpl->tpl_vars['unClient']->value->getVille();?>
">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="tel">Téléphone :</label>
                                    <input type="text" name="tel" class="form-control" readonly value="<?php echo $_smarty_tpl->tpl_vars['unClient']->value->getTelephone();?>
">
                                </div>
                            </div>
