...
class vendeurTable
{
    ...
    public function setCp($cp): void
    {
        if (empty($cp || ctype_space($cp))) {
            self::setMessageErreur("Le Code Postal du vendeur est obligatoire.");
            $this->setAutorisationBD(false);
        }
        $this->cp = $cp;
    }
    ...
    public function setVille($ville): void
    {
        if (empty($ville || ctype_space($ville))) {
            self::setMessageErreur("Le nom de la ville du vendeur est obligatoire.");
            $this->setAutorisationBD(false);
        }
        $this->ville = $ville;
    }
    ...
    public function setTelephone($telephone): void
    {
        if (empty($telephone || ctype_space($telephone))) {
            self::setMessageErreur("Le numéro de téléphone du vendeur est obligatoire.");
            $this->setAutorisationBD(false);
        }
