...
<div id="right-panel" class="right-panel">
    ...
    <div {if VendeurTable::getMessageErreur() neq ''} class="alert alert-danger" role="alert" {/if}>

        {VendeurTable::getMessageErreur()}
    </div>
                        ...
                        <form action="index.php" method="POST">
                            ...
                            <div class="card-body card-block">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="codev" class="form-control" readonly value="{$unVendeur->getCodev()}">
                                    </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="nom">Nom et Prénom :</label>
                                    <input type="text" name="nom" class="form-control" {$readonly} value="{$unVendeur->getNom()}">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="adresse">Adresse :</label>
                                    <input type="text" name="adresse" class="form-control" {$readonly} value="{$unVendeur->getAdresse()}">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="cp">Code Postal :</label>
                                    <input type="text" name="cp" class="form-control" {$readonly} value="{$unVendeur->getCp()}">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="ville">Ville :</label>
                                    <input type="text" name="ville" class="form-control" {$readonly} value="{$unVendeur->getVille()}">
                                </div>
                                <div class="form-group">
                                    <label class="form-control-label" for="telephone">Téléphone :</label>
                                    <input type="text" name="telephone" class="form-control" {$readonly} value="{$unVendeur->getTelephone()}">
                                </div>
                            </div>
